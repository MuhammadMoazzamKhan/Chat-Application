  ...
  return (
    <SafeAreaView className='flex-1'>
      ...
      <View className=' flex-1 -mt-6 rounded-tr-3xl rounded-tl-3xl' style={styles.background}>
        <View className='mx-2 mt-3 space-y-2 mb-20'>
        ...
        <View className='w-full absolute bottom-0'>
          <View className='mx-2 mb-1 flex-row justify-between items-center bg-[#00000040] rounded-2xl'>
            <TextInput placeholder='Message' placeholderTextColor="white" className='flex-1 pl-4 py-2 text-white font-semibold text-base' />
            <TouchableOpacity onPress={pushingmessage} className='bg-[#565E70] p-2 rounded-xl'>
